...
def products_description():
            ...
            parsed_response.append(
                {
                    ...
                    'productName': config.PRODUCTS.get(product_id)['name']
                }
            )
    ...
    wrapped_response = ResponseWrapper(ctl_response=parsed_response, request=request, product=config.PRODUCTS.get('generic'))
...
def generic_product1():
    ...
    wrapped_response = ResponseWrapper(ctl_response=parsed_response, request=request, product=config.PRODUCTS.get('product1'))
...
def generic_product3():
    ...
    wrapped_response = ResponseWrapper(ctl_response=parsed_response, request=request, product=config.PRODUCTS.get('product3'))
...
def generic_product4():
    ...
    wrapped_response = ResponseWrapper(ctl_response=parsed_response, request=request, product=config.PRODUCTS.get('product7'))
...
def generic_product6():
    ...
    wrapped_response = ResponseWrapper(ctl_response=parsed_response, request=request, product=config.PRODUCTS.get('product6'))
...
def generic_product9_ages():
    ...
    wrapped_response = ResponseWrapper(ctl_response=response, request=request, product=config.PRODUCTS.get('product9_ages'))
...
def generic_product9_prev():
    ...
    wrapped_response = ResponseWrapper(ctl_response=response, request=request, product=config.PRODUCTS.get('product9_prev'))
