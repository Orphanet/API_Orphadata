...
class TestReferencesEndpointsStatus(BaseTestCase):
    ...
    def test_status_200_references_base(self):
        ...
        CHECK:
            - response status is 200
        """
        url_endpoint = URL_ENDPOINTS.get('references_base')
    ...
    def test_status_200_references_orphacodes(self):
        ...
        CHECK:
            - response status is 200
        """
        url_endpoint = URL_ENDPOINTS.get('references_orphacodes')        
        response = self.client.get(url_endpoint)
        self.assert200(response)
    ...
    def test_status_200_references_by_orphacode(self):
        ...
        CHECK:
            - response status is 200
        """
        url_endpoint = URL_ENDPOINTS.get('references_by_orphacode').format(self.valid_orphacode)
        response = self.client.get(url_endpoint)
        self.assert200(response)
    ...
    def test_status_404_references_by_orphacode(self):
        ...
        CHECK:
            - response status is 404
        """
        url_endpoint = URL_ENDPOINTS.get('references_by_orphacode').format(self.invalid_orphacode)
        response = self.client.get(url_endpoint)
    ...
    def test_status_200_references_by_name(self):
        ...
        CHECK:
            - response status is 200
        """
        url_endpoint = URL_ENDPOINTS.get('references_by_name').format(self.valid_name)
        response = self.client.get(url_endpoint)
        self.assert200(response)
    ...
    def test_status_404_references_by_name(self):
        ...
        CHECK:
            - response status is 404
        """
        url_endpoint = URL_ENDPOINTS.get('references_by_name').format(self.invalid_name)
        response = self.client.get(url_endpoint)
        self.assert404(response)
    ...
    def test_status_200_references_by_omim(self):
        ...
        CHECK:
            - response status is 200
        """
        url_endpoint = URL_ENDPOINTS.get('references_by_omim').format(self.valid_omim)
        response = self.client.get(url_endpoint)
        self.assert200(response)
    ...
    def test_status_404_references_by_omim(self):
        ...
        CHECK:
            - response status is 404
        """
        url_endpoint = URL_ENDPOINTS.get('references_by_omim').format(self.invalid_omim)
        response = self.client.get(url_endpoint)
        self.assert404(response)
    ...
    def test_status_200_references_icds(self):
        ...
        CHECK:
            - response status is 200
        """
        url_endpoint = URL_ENDPOINTS.get('references_icds')        
        response = self.client.get(url_endpoint)
        self.assert200(response)
    ...
    def test_status_200_references_by_icd(self):
        ...
        CHECK:
            - response status is 200
        """
        url_endpoint = URL_ENDPOINTS.get('references_by_icd').format(self.valid_icd)
        response = self.client.get(url_endpoint)
        self.assert200(response)
    ...
    def test_status_404_references_by_icd(self):
        ...
        CHECK:
            - response status is 404
        """
        url_endpoint = URL_ENDPOINTS.get('references_by_icd').format(self.invalid_icd)
        response = self.client.get(url_endpoint)
        self.assert404(response)
