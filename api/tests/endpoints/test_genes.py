...
class TestGenesEndpointsStatus(BaseTestCase):
    ...
    def test_status_200_genes_orphacodes(self):
        ...
        CHECK:
            - response status is 200
        """
        url_endpoint = self.URL_ENDPOINTS.get('genes_orphacodes')        
        response = self.client.get(url_endpoint)
        self.assert200(response)
    ...
    def test_status_200_genes_by_orphacode(self):
        ...
        CHECK:
            - response status is 200
        """
        url_endpoint = self.URL_ENDPOINTS.get('genes_by_orphacode').format(self.valid_orphacode)
        response = self.client.get(url_endpoint)
        self.assert200(response)
    ...
    def test_status_404_genes_by_orphacode(self):
        ...
        CHECK:
            - response status is 404
        """
        url_endpoint = self.URL_ENDPOINTS.get('genes_by_orphacode').format(self.invalid_orphacode)
        response = self.client.get(url_endpoint)
    ...
    def test_status_200_genes_by_symbol(self):
        ...
        CHECK:
            - response status is 200
        """
        url_endpoint = self.URL_ENDPOINTS.get('genes_by_symbol').format(self.valid_symbol)
        response = self.client.get(url_endpoint)
        self.assert200(response)
    ...
    def test_status_404_genes_by_symbol(self):
        ...
        CHECK:
            - response status is 404
        """
        url_endpoint = self.URL_ENDPOINTS.get('references_by_name').format(self.invalid_symbol)
        response = self.client.get(url_endpoint)
        self.assert404(response)
    ...
    def test_status_200_genes_genes(self):
        ...
        CHECK:
            - response status is 200
        """
        url_endpoint = self.URL_ENDPOINTS.get('genes_genes')        
        response = self.client.get(url_endpoint)
        self.assert200(response)
    ...
    def test_status_200_genes_by_name(self):
        ...
        CHECK:
            - response status is 200
        """
        url_endpoint = self.URL_ENDPOINTS.get('genes_by_name').format(self.valid_name)
        response = self.client.get(url_endpoint)
        self.assert200(response)
    ...
    def test_status_404_genes_by_name(self):
        ...
        CHECK:
            - response status is 404
        """
        url_endpoint = self.URL_ENDPOINTS.get('genes_by_name').format(self.invalid_name)
        response = self.client.get(url_endpoint)
        self.assert404(response)
